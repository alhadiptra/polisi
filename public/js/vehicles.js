    ...
    function displayVehicles(data) {
        ...
        data.forEach((item, index) => {
            ...
            row.innerHTML = `
                    ...
                    <td>
                    <button type="button" class="btn btn-warning shadow rounded-pill "
                        data-bs-toggle="modal" data-bs-target="#editVehicleModal"
                        onclick="showEditVehicleModal(${item.id}, ${index})">
                        <i class="fas fa-edit"></i> Edit
                    </button>

                    <button type="button" class="btn btn-danger shadow rounded-pill"
                        onclick="confirmDeleteVehicle(${item.id})">
